...
public class CalculadoraEstadisticas
{
	...
	public String atletasPorNombre(String nombreAtleta)
	{
		Pais pais;
		String resultado;
		Atleta nombreAtletico = BuscarAltletaPorNombre(nombreAtleta);
		pais= nombreAtletico.darPais();
	...
	public Atleta BuscarAltletaPorNombre(String nombreAtleta)
	{
		Atleta nombre = null;
		for (int i = 0; i < atletas.size() && nombre == null; i++)
		{
			if (atletas.get(i).darNombre().equals(nombreAtleta))
				nombre = atletas.get(i);
		}
		return nombre;
	}
	/**
