...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el país de un atleta por nombre");
	...
	private void ejecutarAtletasPorNombre()
	{
		System.out.println("\n" + "Nombre de país de un atleta" + "\n");

		String nombre = input("Ingrese el nombre del atleta");
		String atletas = calculadora.atletasPorNombre(nombre);
		if (atletas == null)
		{
			System.out.println("No existe un país con ese nombre");
		}
		...
		{
			System.out.println("El atleta "+nombre+" es del país "+atletas);
		}
	}
	/**
